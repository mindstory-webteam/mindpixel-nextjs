...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* ══ DESKTOP & TABLET (md+) ══ */}
      <div className="navbar-syne hidden md:flex fixed top-0 left-0 right-0 z-50 justify-center items-center w-full pointer-events-none px-3 sm:px-5 md:px-6 lg:px-17 xl:px-18">
        <nav
          className="pointer-events-auto relative flex flex-row items-center justify-between w-full max-w-335 lg:max-w-none"
          style={{
            paddingLeft: '22px',
            paddingRight: '22px',
            paddingTop: '10px',
        ...
        >
          <div className="shrink-0 flex items-center">
            <Image
              ...
              height={32}
              priority
              className="w-24 sm:w-26 md:w-28 h-auto cursor-pointer"
              onClick={() => navigateTo('/')}
            />
          </div>
